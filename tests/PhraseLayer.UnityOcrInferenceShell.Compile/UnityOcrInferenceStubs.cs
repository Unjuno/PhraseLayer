...
// Compile-only declarations. These stubs do not execute graphics or inference and are never runtime evidence.
namespace UnityEngine
{
    ...
    public enum HideFlags { HideAndDontSave = 0 }
    public class Texture : Object
    {
        public int width { get; set; }
        public int height { get; set; }
    }
    public sealed class TextAsset : Object { public string text { get; set; } = string.Empty; }
    ...
    public enum RenderTextureFormat { ARGBHalf = 0 }
    public enum RenderTextureReadWrite { Linear = 0 }
    public enum FilterMode { Bilinear = 0, Point = 1 }
    ...
    public static class Graphics { public static void Blit(Texture source, RenderTexture destination, Material material, int pass) { } }
    public enum TextureFormat { RGBA32 = 0 }
...
{
    public enum BackendType { GPUCompute = 0, CPU = 1 }
    public enum DataType { Float = 0, Int = 1, Bool = 2 }
    public enum TensorLayout { NCHW = 0, NHWC = 1 }
    public enum CoordOrigin { TopLeft = 0, BottomLeft = 1 }
    public enum ChannelSwizzle { RGBA = 0, BGRA = 1 }
    public sealed class ModelAsset : UnityEngine.Object { }
    public sealed class ModelInput { public DataType dataType; }
    ...
    public static class ModelLoader { public static Model Load(ModelAsset modelAsset) => new Model(); }
    public readonly struct TensorShape
    {
        private readonly int[] dimensions;
        public TensorShape(params int[] dimensions) { this.dimensions = dimensions ?? Array.Empty<int>(); }
    ...
    public sealed class Tensor<T> : Tensor where T : unmanaged
    {
        ...
        public Tensor(TensorShape shape) { tensorShape = shape; }
        public Tensor(TensorShape shape, T[] data) { tensorShape = shape; }
    ...
    {
        public static void ToTensor(UnityEngine.Texture texture, Tensor<float> tensor, TextureTransform transform = default) { }
    }
    ...
    public sealed class FunctionalGraph
    {
        ...
        public FunctionalTensor AddInput(DataType dataType, TensorShape shape, string name = null) => new FunctionalTensor();
    ...
    public static class Functional
    {
        ...
        public static FunctionalTensor Float(this FunctionalTensor input) => new FunctionalTensor();
        public static FunctionalTensor Unsqueeze(this FunctionalTensor input, int dim) => new FunctionalTensor();
        public static FunctionalTensor Concat(FunctionalTensor[] tensors, int dim = 0) => new FunctionalTensor();
    }
...
namespace PhraseLayer.Unity
{
    ...
    {
        public static IReadOnlyList<PaddleDbQuadDetection> DecodeV6TinyQuads(this PaddleDetectorRawOutput output,

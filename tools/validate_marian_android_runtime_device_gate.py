...
def validate() -> dict[str, object]:
    ...
    for fragment in (
        ...
        'bootstrap_ready={_BOOL} translation_override={_BOOL}',
    ...
    return {
        ...
        "coherent_success_state_required": True,
        "runtime_execution_false_claim_prevented": True,
        "failure_command_stderr_redacted": True,
        "safe_failure_readiness_diagnostics_allowed": True,

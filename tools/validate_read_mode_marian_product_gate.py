...
def validate() -> dict[str, object]:
    ...
    for fragment in (
        ...
        "Require real Unity pinned PP-OCR inference and detector plus recognizer GPU preprocess parity",
    ...
    return {
        ...
        "pinned_ppocr_real_unity_inference_required": True,
        "pinned_ppocr_detector_gpu_preprocess_parity_required": True,
        "pinned_ppocr_recognizer_gpu_preprocess_parity_required": True,

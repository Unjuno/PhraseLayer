...
def validate() -> dict[str, object]:
    ...
    # Workflow Python snippets are intentionally free to combine assertions. Validate the required expressions,
    # not formatting details such as whether an expression starts a new `assert` statement.
    for fragment in (
        ...
        'data["scripting_backend"] == "IL2CPP"',
        'data["product_translation_gate"] is True',
        'data["apk_upload_allowed"] is False',
        'tokenizer["il2cpp_reflection_preserve_required"] is True',
        "inspect_android_apk_structure.py",
        "marian-product-apk-structure.json",
        'apk_struct["native_abis"] == ["arm64-v8a"]',
        'apk_struct["il2cpp_native_library_present"] is True',
        'apk_struct["unity_player_library_present"] is True',
        'apk_struct["model_asset_presence_proven_by_zip_structure"] is False',
    ...
    return {
        ...
        "workflow_semantic_expressions_required": True,
